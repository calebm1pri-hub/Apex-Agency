...
/**
 * TikTok Pixel loader. Renders nothing (and costs nothing) until you set
 * NEXT_PUBLIC_TIKTOK_PIXEL_ID — then it tracks PageView + commerce events for
 * TikTok Shop attribution and ad optimization.
 */
